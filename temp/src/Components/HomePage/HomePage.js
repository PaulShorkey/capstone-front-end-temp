...
export default function Home(props) {
	...
	useEffect(() => {
		const setResponsiveness = () => {
			return window.innerWidth < 1280 ? setIsMobileView(true) : setIsMobileView(false)
		}
	...
	// ************************************************** CALLBACKS ******************************************************* //
	const updateGroupTitleModal = (data) => {
		setGroupData(data)
		setMessagesNeedUpdating(true)
	}

	const updateMessageViewComponent = (value) => {
						...
						<Grid container>
							...
							<Grid key='MessagesView' item className={classes.messagesView}>
								<MessagesView
									...
									groupData={groupData}
									messagesNeedUpdating={messagesNeedUpdating}
									updateMessageViewComponent={updateMessageViewComponent}
								/>
							</Grid>
						</Grid>
					</Grid>
